    ...
    <div className="min-h-screen bg-[#F5F5F5]">
      ...
      <section className="relative h-screen flex items-center justify-center text-center text-white">
        ...
        <div className="relative z-20 max-w-4xl mx-auto px-4">
          <p className={`text-4xl md:text-[64px] mb-6 ${greatVibes.className}`}>
            Welcome to
          </p>
          <h1
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[936px] mx-auto">
            ...
            <div className="relative group w-full overflow-hidden rounded-xl">
              ...
              <div className="absolute bottom-0 w-full py-4 flex flex-col items-center md:w-[288px] z-20 transition-all duration-300 group-hover:-translate-y-20">
                <span
                  className={`text-[#CFA83C] text-sm md:text-2xl font-semibold ${dmSans.className} group-hover:mb-6`}
                >
                  Sunday <br />
                  Worship Service
                </span>
              ...
              <div className="absolute bottom-0 w-full py-4 flex flex-col items-center md:w-[288px] z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-y-0 translate-y-20">
                ...
                <span
                  className={`text-[#CFA83C] text-xs md:text-lg font-medium ${dmSans.className}`}
                >
                  Timezone: GMT +1
                  <br />
                  1st Service: 6:30am
            ...
            <div className="relative group w-full overflow-hidden rounded-xl">
              ...
              <div className="absolute bottom-0 w-full py-4 flex flex-col items-center md:w-[288px] z-20 transition-all duration-300 group-hover:-translate-y-20">
                <span
                  className={`text-white text-sm md:text-2xl font-semibold ${dmSans.className}`}
                >
                  Healing and <br />
                  Deliverance Service
                </span>
              ...
              <div className="absolute bottom-0 w-full py-4 flex flex-col items-center md:w-[288px] z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:translate-y-0 translate-y-20">
                <hr className="hidden md:block w-40 border-t-2 border-white my-2" />
                <span
                  className={`text-white text-xs md:text-lg font-medium ${dmSans.className}`}
                >
                  Timezone: GMT +1
                  <br />
      ...
      <section className="py-16 max-w-[1120px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="relative group">
            <h1
              className={`text-[#3C4A5A] mt-10 md:mt-0 mb-5 md:mb-10 font-medium text-sm md:text-lg ${dmSans.className}`}
            >
              Hear God’s Word <br />
